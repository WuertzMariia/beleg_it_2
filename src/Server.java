...
public class Server extends JFrame implements ActionListener, ChangeListener {
  ...
  private String describe() {
    ...
    rtspBody.write("m=video " + "RTP_dest_port" + " RTP/AVP " + MJPEG_TYPE + CRLF); // Variablen funktionieren nicht - in den Klammern !
    rtspBody.write("a=control:streamid=" + "RTSPid" + CRLF);
